...
$stmt = $conn->prepare('SELECT * FROM rides WHERE user_id = ? ORDER BY ride_date, ride_time');
        ...
        <div class="card">
            ...
            <?php if ($result->num_rows === 0) { ?>
                <div class="empty-state">
                    ...
                    <p>Book an available ride to see it here.</p>
                </div>
            <?php } else { ?>
                <table>
                    <thead>
                    ...
                    <tbody>
                        <?php while ($row = $result->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td>
                                    <span class="<?php echo e(strtolower($row['status'])); ?>">
